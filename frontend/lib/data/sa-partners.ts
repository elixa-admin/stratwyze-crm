...
export const SA_PARTNERS: SAPartner[] = [
...

  {
    ...
    employees: 'Unknown',
    website: '',
    tagline: 'SI/Consultancy not yet identified',
    serviceDescription: 'Incumbent SI partner or consultancy not yet identified. Run AI research to discover provider details.',
    keyServices: [],
    targetSegment: 'Unknown',
    strengths: [],
    weaknesses: [],
    stratwyzeAdvantages: [
      'Research needed to identify specific provider and develop competitive positioning.',
    ],
    flankingStrategy: {
      situation: 'Provider unknown — research required',
      approach: 'Use AI research to identify incumbent SI and develop targeted flanking strategy.',
      keyMessage: 'Incumbent SI partner not yet identified.',
      talkingPoints: [],
      watchOut: 'Identify provider before developing sales strategy.',
    },
    typicalDealSize: 'Unknown',
    salesCycle: 'Unknown',
    evidenceSources: [],
