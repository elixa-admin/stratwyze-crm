...
export const SA_PARTNERS: SAPartner[] = [
  ...
  // ─── SA SYSTEM INTEGRATORS (competing platform SIs — enterprise focused) ────

  {
    ...
    category: 'Competing Platform Partner',
    platformAlignment: 'ServiceNow',
    threatLevel: 'Primary' as const,
    headquarters: 'Midrand, Johannesburg',
    province: 'Gauteng',
    founded: 2019,
    employees: '5000+',
    website: 'https://www.ioco.tech',
    tagline: 'SA\'s largest IT solutions provider — ServiceNow & BMC premier partner',
    serviceDescription:
      'iOCO is South Africa\'s largest IT solutions and services company, formed from the restructuring of EOH Group, which absorbed Britehouse (formerly SA\'s #1 ServiceNow partner). They hold ServiceNow Premier Partner status and BMC Elite Partner status, making them the dominant enterprise ITSM SI in SA. With 5,000+ staff across SA and Africa, they bring enterprise delivery capability that smaller pure-plays cannot match on headcount alone.',
    keyServices: [
      'ServiceNow implementation (ITSM, ITOM, HRSD, SecOps)',
      'BMC Helix and Remedy modernisation',
      'Enterprise IT managed services',
      'Cloud migration and hybrid infrastructure',
      'ITIL process consulting',
      'Custom workflow development',
    ],
    targetSegment: 'JSE Top 100, government entities, parastatal organisations, financial services',
    strengths: [
      'ServiceNow Premier Partner — highest tier in SA',
      'BMC Elite Partner — dual platform reach',
      'Absorbed Britehouse — inherited strong ServiceNow delivery team',
      'Massive delivery scale: 5,000+ SA staff across all IT disciplines',
      'Preferred supplier status with many JSE-listed enterprises',
      'Broad insurance, banking, mining, and telecom vertical relationships',
      'End-to-end IT outsourcing capability (infra + service desk + ITSM)',
    ],
    weaknesses: [
      'Post-EOH restructuring governance issues have damaged enterprise trust',
      'Size creates slow response times and bureaucratic sales cycles',
      'ServiceNow licensing drives 3-5× higher TCO than HaloITSM',
      'Complex pricing with hidden PS and module costs',
      'Incentivised to upsell ServiceNow modules — not always in client interest',
      'Does not have HaloITSM capability — cannot offer the alternative',
      'Implementation timelines of 12-18 months are common',
    ],
    stratwyzeAdvantages: [
      'HaloITSM is 60-75% lower TCO than ServiceNow over 3 years — verifiable with published pricing',
      'Stratwyze delivers in 4-8 weeks vs iOCO\'s 12-18 months',
      'Pure-play HaloITSM — no competing interests or platform upsell pressure',
      'iOCO\'s EOH history creates governance and trust concerns at board level',
      'Stratwyze provides SA-based support with 4hr P1 SLA — iOCO\'s service desk is centralised and impersonal',
      'HaloCRM + HaloITSM + HaloPSA from one partner — iOCO cannot match this in one team',
    ],
    flankingStrategy: {
      situation: 'iOCO is incumbent or shortlisted for a ServiceNow ITSM deal at an SA enterprise.',
      approach: 'Lead with TCO disruption — ServiceNow\'s published per-user pricing vs HaloITSM\'s named agent model. Then attack delivery risk using iOCO\'s EOH governance history. Offer a 30-day proof of concept.',
      keyMessage: 'iOCO brings scale and ServiceNow brand — but at 3× the cost, 4× the timeline, and with a cloud-only dependency. HaloITSM + Stratwyze delivers the same ITIL 4 outcomes at a fraction of the price with local ownership and POPIA-first deployment.',
      talkingPoints: [
        'Request a 3-year TCO comparison: ServiceNow\'s module-based pricing vs HaloITSM\'s flat per-agent model will reveal a 60-75% cost difference.',
        'Ask iOCO for references from implementations completed in under 3 months. You won\'t find many.',
        'iOCO\'s EOH restructuring is recent — ask how governance and accountability works at the delivery level.',
        'ServiceNow requires cloud hosting; HaloITSM supports on-premises or SaaS — POPIA data sovereignty is fully in your hands.',
        'We can show you a live HaloITSM environment configured for your industry in 2 weeks. No consulting fees for the PoC.',
      ],
      watchOut: 'iOCO\'s scale and existing relationships are their strongest card. Don\'t fight on brand — fight on TCO and speed.',
    },
    typicalDealSize: 'R1M–R20M (large enterprise ServiceNow rollouts)',
    salesCycle: '6–18 months',
    evidenceSources: [
      'https://www.ioco.tech/solutions/business-solutions/service-management/',
      'EOH 2025 Annual Report — iOCO restructuring details',
    ],
  ...
  {
    id: 'dimension-data-sa',
    name: 'Dimension Data (NTT SA)',
    avatar: 'DD',
    category: 'Competing Platform Partner',
    platformAlignment: 'ServiceNow',
    threatLevel: 'Secondary' as const,
    headquarters: 'Bryanston, Johannesburg',
    province: 'Gauteng',
    founded: 1983,
    employees: '3000+',
    website: 'https://www.dimensiondata.com/en-ZA',
    tagline: 'Global technology services giant — NTT Group, ServiceNow delivery in SA',
    serviceDescription:
      'Dimension Data, now a wholly owned subsidiary of NTT Group (Japan), is one of SA\'s oldest and largest IT services companies. They hold ServiceNow Partner status and deliver ITSM implementations across their large enterprise and government client base. Their strength is the NTT global network and their deep relationships with JSE-listed conglomerates built over 40+ years.',
    keyServices: [
      'ServiceNow implementation and managed services',
      'Network infrastructure and cloud',
      'Unified communications and collaboration',
      'Security operations centre',
      'ITIL process consulting',
    ],
    targetSegment: 'JSE-listed multinationals, mining, banking, telecommunications',
    strengths: [
      'NTT Group backing — global delivery reach and R&D investment',
      '40+ year SA relationships with blue-chip enterprises',
      'ServiceNow certified delivery team',
      'Strong managed services wrapping around ITSM implementations',
      'Broad technology stack — can bundle networking, cloud, and ITSM',
    ],
    weaknesses: [
      'Offshore NTT ownership creates decision-making delays and local accountability gaps',
      'ServiceNow licensing adds 3-5× TCO premium compared to HaloITSM',
      'Cloud-only ServiceNow deployment conflicts with POPIA on-premises requirements',
      'Implementation cycles of 12+ months are standard for enterprise deals',
      'High day-rates driven by NTT corporate overhead',
      'ITSM is not their primary revenue driver — bundled into broader IT contracts',
    ],
    stratwyzeAdvantages: [
      'HaloITSM at 60-75% lower 3-year TCO than ServiceNow',
      'Stratwyze is SA-born with no offshore ownership diluting focus',
      'POPIA on-premises deployment option — Dimension Data cannot offer this with ServiceNow',
      'Dedicated HaloITSM specialists vs Dimension Data\'s generalist delivery teams',
      'Faster implementation: 4-8 weeks vs Dimension Data\'s typical 12-18 month enterprise timeline',
    ],
    flankingStrategy: {
      situation: 'Dimension Data is proposed as the ITSM delivery partner on a large SA enterprise deal.',
      approach: 'Highlight the offshore ownership gap and NTT overhead costs. Use POPIA on-premises as a hard differentiator. Offer a side-by-side TCO comparison.',
      keyMessage: 'Dimension Data brings global NTT scale — but ITSM is a side offering bundled into infrastructure deals. Stratwyze is the SA specialist with a purpose-built HaloITSM practice, local accountability, POPIA-native deployment, and a TCO that is 60% lower.',
      talkingPoints: [
        'Dimension Data\'s ITSM practice is secondary to their infrastructure business — who owns your ITSM outcome at a senior level?',
        'NTT offshore ownership means local decisions travel up a global chain. Escalations are slow.',
        'ServiceNow cloud-only means your service data leaves South Africa. HaloITSM can be deployed on-premises inside your own data centre.',
        'Ask for their dedicated HaloITSM team size — they won\'t have one. We do.',
      ],
      watchOut: 'Dimension Data wins on brand trust with long-standing clients. Focus on service management specificity, not broad IT credibility.',
    },
    typicalDealSize: 'R2M–R15M (bundled in larger IT contracts)',
    salesCycle: '9–18 months',
    evidenceSources: [
      'https://www.dimensiondata.com/en-ZA/solutions/service-management',
    ],
    lastVerified: '2026-06-24',
    dataConfidence: 'Medium',
  },

  {
    ...
    category: 'Competing Platform Partner',
    platformAlignment: 'Mixed',
    threatLevel: 'Emerging' as const,
    headquarters: 'Centurion, Pretoria',
    province: 'Gauteng',
    founded: 1996,
    employees: '1500+',
    website: 'https://www.datacentrix.co.za',
    tagline: 'Mid-market SA IT integrator — ManageEngine, ServiceNow, and broad ITSM portfolio',
    serviceDescription:
      'Datacentrix is a JSE-listed SA IT solutions company with a broad ITSM portfolio spanning ManageEngine (Zoho Corp), ServiceNow, and Microsoft ITSM tooling. They are significant in the mid-market and government space, particularly for ManageEngine deployments where they compete directly on pricing. Their JSE listing adds governance credibility for public sector bids.',
    keyServices: [
      'ManageEngine ServiceDesk Plus implementation',
      'ServiceNow (selected implementations)',
      'Microsoft 365 and Azure management',
      'IT infrastructure management',
      'Service desk outsourcing',
    ],
    targetSegment: 'Mid-market SA companies, government departments, municipalities',
    strengths: [
      'JSE-listed — governance credibility for public sector procurement',
      'ManageEngine Gold Partner — competitive pricing in mid-market',
      'Broad SA footprint with offices in multiple provinces',
      'Lower price point than enterprise SIs for mid-market deals',
      'Long SA track record (30 years)',
    ],
    weaknesses: [
      'Multi-platform portfolio means no deep specialisation in any single ITSM tool',
      'ManageEngine lacks ITIL 4 certification — Halo has full PinkVERIFY',
      'ServiceNow capability is limited compared to iOCO or Dimension Data',
      'Mid-market focus means limited large enterprise credibility',
      'JSE listing creates shareholder pressure on margins, limiting PS investment',
    ],
    stratwyzeAdvantages: [
      'HaloITSM is ITIL 4 PinkVERIFY certified — ManageEngine is not',
      'Stratwyze offers full Halo suite (ITSM + CRM + PSA) — Datacentrix cannot match',
      'Named agent licensing vs ManageEngine\'s per-technician model — fairer cost structure',
      'POPIA on-premises HaloITSM vs ManageEngine\'s cloud-only SaaS tier',
    ],
    flankingStrategy: {
      situation: 'Datacentrix is shortlisted for a ManageEngine ITSM deployment at an SA mid-market or government account.',
      approach: 'Lead with ITIL 4 certification gap. ManageEngine ServiceDesk Plus does not hold PinkVERIFY — HaloITSM does. Then attack on licensing model fairness and deployment flexibility.',
      keyMessage: 'Datacentrix offers ManageEngine at a competitive price — but ManageEngine lacks ITIL 4 PinkVERIFY certification and forces cloud SaaS for full features. HaloITSM is fully certified, on-premises capable, and priced per named agent — not per ticket or per technician tier.',
      talkingPoints: [
        'Request PinkVERIFY ITIL 4 certification documentation from ManageEngine. It does not exist at the full suite level.',
        'ManageEngine pricing scales sharply at higher technician counts — model out the 5-year cost at your projected headcount.',
        'Datacentrix resells 4+ ITSM platforms. Ask who their dedicated HaloITSM-equivalent practice lead is for ManageEngine.',
        'HaloITSM on-premises deployment is included in the standard licence — ManageEngine\'s full feature set requires their SaaS tier.',
      ],
      watchOut: 'Datacentrix wins on price familiarity in government. Emphasise compliance and ITIL 4 certification, which public sector procurement criteria often mandate.',
    },
    typicalDealSize: 'R200K–R2M',
    salesCycle: '3–9 months',
    evidenceSources: [
      'https://www.datacentrix.co.za/solutions/it-service-management',
    ],
    lastVerified: '2026-06-24',
    dataConfidence: 'Medium',
  },

  {
    ...
    tagline: 'Global consulting giant — ServiceNow Elite Partner with SA enterprise reach',
    serviceDescription:
      'Accenture SA is the local arm of the global consulting firm, holding ServiceNow Elite Partner status globally — the highest tier. Their SA practice targets the country\'s largest corporations and parastatal entities, typically as part of broader digital transformation mandates. They rarely compete in sub-R5M deals; their strength is at the very top of the SA enterprise market where board-level consulting relationships drive technology decisions.',
    keyServices: [
      'ServiceNow enterprise implementation (ITSM, ITOM, HRSD, GRC, SecOps)',
      'Digital transformation strategy and execution',
      'Change management and organisational design',
      'AI and automation on ServiceNow platform',
      'Post-go-live managed services',
    ],
    targetSegment: 'JSE Top 40, parastatals (Eskom, Transnet, SAA), major banks (FNB, Nedbank, Absa)',
    strengths: [
      'ServiceNow Elite Partner globally — top-tier delivery credentials',
      'C-suite access and board-level consulting relationships',
      'Global delivery centres reduce day-rates for offshore work',
      'Full ServiceNow suite capability including emerging AI/ML modules',
      'Change management and training capability alongside implementation',
    ],
    weaknesses: [
      'Minimum deal size effectively R5M+ — not accessible for mid-market',
      'ServiceNow TCO is 4-5× higher than HaloITSM over 3 years',
      'Implementation timelines of 18-24 months for enterprise rollouts',
      'Offshore delivery model reduces SA accountability and POPIA control',
      'Accenture\'s commercial interests align with maximum ServiceNow module adoption — not TCO',
      'Not competitive for sub-R5M or mid-market opportunities',
    ],
    stratwyzeAdvantages: [
      'Stratwyze is competitive in the R500K–R5M range where Accenture does not play',
      'HaloITSM delivers ITIL 4 outcomes at 75% lower 3-year TCO than ServiceNow',
      'SA-based delivery team with POPIA-native on-premises option',
      '4-8 week implementation vs Accenture\'s 18-24 month enterprise timeline',
    ],
    flankingStrategy: {
      situation: 'Accenture SA is being considered for a major ITSM platform decision at a large SA enterprise.',
      approach: 'Accenture only wins here if the deal is very large. Position HaloITSM as the right-sized, cost-efficient alternative for organisations that don\'t need the ServiceNow monolith. TCO disruption is the primary weapon.',
      keyMessage: 'Accenture and ServiceNow are the right choice for 20,000-agent global enterprises with unlimited budgets. For SA organisations, HaloITSM delivers the same ITIL 4 outcomes at a fraction of the price with local accountability, on-premises sovereignty, and implementation in weeks not years.',
      talkingPoints: [
        'ServiceNow is priced for Fortune 500 companies with 10,000+ agents globally. Ask Accenture to model the 3-year cost for your specific agent count.',
        'Accenture\'s global delivery model means many of your implementation consultants will be offshore — who is accountable locally?',
        'Accenture\'s ITSM practice generates revenue from ServiceNow module upsell. At what point does their recommendation become about their margin?',
        'We can have HaloITSM configured and operational in your environment in 4 weeks. Book a proof of concept.',
      ],
      watchOut: 'If this is a truly large enterprise deal (500+ agents, JSE Top 40), Accenture may be the right choice — don\'t overreach. Focus Stratwyze energy on deals under R5M.',
    },
    typicalDealSize: 'R5M–R50M+ (very large enterprise only)',
    salesCycle: '12–24 months',
    evidenceSources: [
      'https://www.accenture.com/za-en/services/technology/servicenow',
    ],
    lastVerified: '2026-06-24',
    dataConfidence: 'Medium',
  },
