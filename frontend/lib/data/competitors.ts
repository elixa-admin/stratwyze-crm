...
export const COMPETITORS: Competitor[] = [
...

  {
    ...
    tco3Year: {
      competitor: { min: 0, max: 0, currency: 'ZAR' },
      haloITSM: { min: 80000, max: 150000, currency: 'ZAR' },
    },
    ...
    functionality: [],
    marketPosition: {
      gartnerQuadrant: 'Unknown',
      marketShare: 'Unknown',
      targetSegment: 'Unknown',
    },
    salesRebuttal: {
      title: 'Platform to be determined',
      keyMessage: 'Research needed to identify specific platform and develop targeted messaging.',
      weaknesses: [],
      winningPoints: [],
    },
    keyWeaknesses: [
      {
        ...
        description: 'Incumbent platform not yet identified. Run AI research to discover platform details.',
      },
    ],
    recentNews: [],
    maActivity: [],
